...
class GraphContainer extends React.Component {
    constructor(props) {
        ...
        this.getAxisYDomain = () => {
            ...
            this.state.data.forEach((dataPoint) => {
                let [tempBottom, tempTop] = this.getDataPointMinMax(dataPoint, bottom, top);
        ...
        this.getLines = () => {
            ...
            this.props.skills.forEach((skill) => {
                lines.push(React.createElement(Line, { yAxisId: "1", type: "natural", dataKey: skill, stroke: this.skillColorMap.get(skill), animationDuration: 300, dot: false }));
            });
            return lines;
        };
    ...
    render() {
        ...
        return (React.createElement("div", { className: "highlight-bar-charts", style: { userSelect: "none" } },
            React.createElement("button", { className: "btn update", onClick: this.zoomOut.bind(this) }, "Zoom Out"),
            React.createElement(LineChart, { width: 800, height: 400, data: data, onMouseDown: (e) => this.setState({ refAreaLeft: e.activeLabel }), onMouseMove: (e) => this.state.refAreaLeft &&
                    this.setState({ refAreaRight: e.activeLabel }), onMouseUp: this.zoom.bind(this) },
                React.createElement(CartesianGrid, { strokeDasharray: "3 3" }),
                React.createElement(XAxis, { allowDataOverflow: true, dataKey: "timeStamp", domain: [left, right], type: "category" }),
                React.createElement(YAxis, { allowDataOverflow: true, domain: [bottom, top], type: "number", yAxisId: "1" }),
                React.createElement(Tooltip, null),
                this.getLines(),
                refAreaLeft && refAreaRight ? (React.createElement(ReferenceArea, { yAxisId: "1", x1: refAreaLeft, x2: refAreaRight, strokeOpacity: 0.3 })) : null)));
    }
}
